          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 mb-4">
                We are a team from Hanoi University of Science and Technology, joining the NASA Space Apps Challenge 2025. 
                Our mission is to advance space biology research and share knowledge for the benefit of humanity.
              </p>
